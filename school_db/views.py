...
def problem_one(request):
  ...
  for student in students:
    print(f'First Name: {student.first_name} Last Name: {student.last_name} {student.gpa}')
...
def problem_two(request):
  ...
  for instructor in instructors:
    print(f'First Name: {instructor.first_name} Last Name: {instructor.last_name} {instructor.hire_date}')
